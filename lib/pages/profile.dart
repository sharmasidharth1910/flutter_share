...
class _ProfileState extends State<Profile> {
  ...
  handleFollowUser() {
    ...
    //(update your following collection)
    followingRef
        .document(currentUserId)
        .collection("userFollowing")
        .document(widget.profileId)
        .setData({});
    //add activity feed item for that user to notify
    //about new follower (us)
    activityFeedRef
        .document(widget.profileId)
        .collection("feedItems")
        .document(currentUserId)
  ...
  buildProfileButton() {
    ...
    //viewing own profile then should show edit profile button
    if (isProfileOwner) {
